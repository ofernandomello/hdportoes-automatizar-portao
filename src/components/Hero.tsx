  ...
  return (
    <section className="relative min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img 
          src={heroImage} 
          alt="Portão automatizado moderno" 
      ...
      <div className="container relative z-10 mx-auto px-4 py-20">
        <div className="max-w-2xl">
          ...
          <p className="text-xl md:text-2xl text-background/90 mb-8 leading-relaxed">
            Chegue em casa sem precisar descer do carro. Abertura em 4 segundos, 
            instalação profissional e parcelamento em até 10x sem juros.
          </p>

          {/* Benefits List */}
          <div className="space-y-3 mb-10">
            {[
              "Abertura em apenas 4 segundos",
              "Parcelamento em 10x sem juros",
              "Instalação profissional com garantia",
              "Aumento da segurança da sua família"
            ].map((benefit, index) => (
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button 
              size="lg" 
              variant="outline"
              className="bg-background/10 backdrop-blur-sm hover:bg-background/20 text-background border-2 border-background/30 font-montserrat font-semibold text-lg px-8 py-6 rounded-xl transition-all"
              onClick={() => document.getElementById('motores')?.scrollIntoView({ behavior: 'smooth' })}
            >
              Ver Modelos
            </Button>
          </div>
